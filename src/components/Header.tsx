...
const Header = () => {
  ...
  return (
    <div
      className={`bg-off-white grid max-md:grid-cols-1 md:m-10 md:mb-0 lg:mr-0 transition-transform ease-in-out md:grid-cols-[1fr,2fr] lg:grid-cols-1  md:gap-6 gap-8 lg:w-[255px] ${isOpen&&"max-md:before:w-full"} max-md:before:absolute max-md:before:left-0 max-md:before:top-[72px] z-50 max-md:before:h-screen max-md:before:bg-transparent/60 "
        ${
          isOpen
